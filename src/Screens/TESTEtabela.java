...
import Processos.Coleta_Imagem;
import Services.TESTETableModelAdotados;
import Services.TESTETableModelAdotados;
import Services.TESTETableModelAnimal;
 ...
 * @author aluno 
 */
public class TESTEtabela extends javax.swing.JPanel {
    private CardLayout cardPaiTabela; 
    private CardLayout cardPaiLeft; 
    private TESTETableModelAnimal modeloTabela;
    private TESTETableModelAdotados modeloTabela2;
    ...
    public TESTEtabela() throws Exception {
        initComponents();
        modeloTabela = new TESTETableModelAnimal();
        modeloTabela2 = new TESTETableModelAdotados();
...
/**
    ...
    private void initComponents() {
        ...
        jTable2.setSelectionBackground(new java.awt.Color(56, 0, 56));
    ...
    private void lblPesquisarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblPesquisarMouseClicked
        ...
        if(jcheqNome.isSelected() || jcheqIdade.isSelected()){
            modeloTabela2 = new TESTETableModelAdotados(animais);
    ...
    private void preencherComboBoxAnimaisAdocao(JComboBox jcbAnimaisParaAdotar){
        ...
        try {
            for(Animal animal : controllerAnimal.getList()){
    ...
    private void jpnExcluirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jpnExcluirMouseClicked
        ...
        try {
            this.modeloTabela = new TESTETableModelAnimal();
            jTable1.setModel(modeloTabela);
            jTable1.getColumnModel().getColumn(0).setPreferredWidth(150);
            jTable1.setRowHeight(150);
        } catch (Exception ex) {
    ...
    private void atualizarAnimalAdocao(){
        int i = jTable1.getSelectedRow();
        Animal animal_up = modeloTabela.getRowSelected(i);
        
        //AnimalAdocao animal_up = jcbAnimais.getSelectedItem();
...
//    }
    ...
    private void atualizarTabelasPosAdocao(){
        ...
        Animal animal =  modeloTabela.getRowSelected(row);
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        int row = jTable2.getSelectedRow();
        Animal animal =  modeloTabela.getRowSelected(row);
        jlbNomeAnimalAdocao.setText(animal.getNome());
        //////////////////////////////////////////////////////////////
        preencherLabelsDescricao(animal);
        
    }//GEN-LAST:event_jTable2MouseClicked
    
    private void preencherLabelsDescricao(Animal animal){
        jtfEspecie.setText(animal.getEspecie());
        jtfNome.setText(animal.getNome());
        jtfIdade.setText(String.valueOf(animal.getIdade()));
        jtfPorte.setText(animal.getPorte());
        jtfRaca.setText(animal.getRaca());
        jtfCor.setText(animal.getCor());
        if(animal.getSexo().equals("Macho")){
            jrbMacho.setSelected(true);
            jpnPrenha.setVisible(false);
        }else if(animal.getSexo().equals("femea")){
        ...
        else if(!animal.isVacinado())
            jrbVacinadoNao.setSelected(true);
        if(animal.isCastrado())
            jrbCastradoSim.setSelected(true);
        else if(!animal.isCastrado())
            jrbCastradoNao.setSelected(true);
        
        jtfDoenca.setText(animal.getQualDoenca());
                        
        jtaDescricao.setText(animal.getDescricao());
        
        txt_imagem.setIcon(animal.getImagemIcon());
...
//        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        Animal animal =  (Animal) modeloTabela2.getRowSelected(row);
        //////////////////////////////////////////////////////////////
    ...
    private void ColetarDadosAdocao(){
        ...
        int row = jTable2.getSelectedRow();
        Animal animal =  modeloTabela.getRowSelected(row);
        //AnimalAdocao animal = jcbAnimais1.getSelectedItem();
        
//        Adotante adotante;
//        adotante = (Adotante) jcbSelecioneAdotante.getSelectedItem();
//        
//        AnimalAdotado animalAdotado = new AnimalAdotado(adotante.getIdAdotante(), hojeFormatado, animal.getId());
...
//        
//        try {
//            daoAnimalAdotado.updateAdocaoParaAdotado(animal);
//        } catch (Exception ex) {
//            Logger.getLogger(TESTEtabela.class.getName()).log(Level.SEVERE, null, ex);
//        }
    }
