 ...
 * @author Daniela
 */
public class MyTableModelAdotados extends AbstractTableModel {
    ...
    public MyTableModelAdotados() throws Exception{
    ...
    //O construtor já recebe os dados do ArrayList para exibição 
    public MyTableModelAdotados (ArrayList<Animal> a){
        this.animals = a;
