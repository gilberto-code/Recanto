 ...
 * @author Daniela
 */
public class TESTETableModelAnimal extends AbstractTableModel {
    ...
    public TESTETableModelAnimal() throws Exception{
    ...
    //O construtor já recebe os dados do ArrayList para exibição 
    public TESTETableModelAnimal (ArrayList<Animal> a){
        this.animals = a;
